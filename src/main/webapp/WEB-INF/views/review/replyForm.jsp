  ...
  <body style="padding-top: 72px;">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav ml-auto">
              ...
              <c:if test="${loginID!=null}">
                  <li class="nav-item mt-3 mt-lg-0 ml-lg-3 d-lg-none d-xl-inline-block"><a class="btn btn-primary" href="rlist">Review</a></li>
              </c:if>
              <c:if test="${loginID==null}">  
    ...
    <section class="hero py-6 py-lg-7 text-white dark-overlay"><img class="bg-image" src="resources/myLib/img/review.jpg" alt="????" >
      <div class="container overlay-content">
        <!-- Breadcrumbs -->
        <a href="#" ><h1 class="hero-heading">&nbsp;</h1></a>
      </div>
    </section>
    <section class="py-6">
      <div class="container">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="1" name="brtitle" id="brtitle" placeholder="Enter your Title" required="required"></textarea>
                    </div>
                  </div>
                </div>
                <div class="form-group">
